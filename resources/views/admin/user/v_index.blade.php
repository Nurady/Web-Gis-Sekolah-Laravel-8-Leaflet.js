        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('user.create') }}" class="btn btn-sm btn-primary btn-flat text-white">
                    ...
                    <tbody>
                        @foreach ($users as $key=>$user)
                            <tr>
                                ...
                                <td>{{ $user->email }}</td>
                                <td>
                                    <img class="rounded" height="100px" src="{{ Storage::url($user->photo) }}" alt="{{ $user->name ?? 'name'}}">
                                </td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <a href="{{ route('user.delete', $user->id) }}" class="btn btn-primary">Ya, Hapus</a>
                    </div>
                </div>
            </div>
        </div>        
